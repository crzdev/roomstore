class AddMoAdministrativeAreaAndMosSubadministrativeAreas < ActiveRecord::Migration
  def self.up
    mo = AdministrativeArea.new(:name => "Московская Область")
    mo.save
    ...
    list.each do |el|
      (SubAdministrativeArea.new(:name => el,:administrative_area_id => mo.id)).save
    end
  end
