ActionController::Routing::Routes.draw do |map|
  ...
  map.connect "user_entries/new_rent_nonresid_moscow", :controller => "user_entries", :action => "new_rent_nonresid_moscow"
  map.connect "user_entries/new_rent_nonresid_mo", :controller => "user_entries", :action => "new_rent_nonresid_mo"
  map.connect "user_entries/new_rent_room_flat_moscow", :controller => "user_entries", :action => "new_rent_room_flat_moscow"
  map.connect "user_entries/new_rent_room_flat_mo", :controller => "user_entries", :action => "new_rent_room_flat_mo"
