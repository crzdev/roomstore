...
window.onload = function() {
		a["search_condition[mo_districts][]"] = document.forms[0]["search_condition[mo_districts][]"];
    left_list = document.forms[0]["mo_districts[district]"];
		right_list = document.forms[0]["search_condition[mo_districts][]"];
